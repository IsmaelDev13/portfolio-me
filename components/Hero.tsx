          ...
          <form onSubmit={sendEmail} className="ml-6 flex items-center ">
            <label>
              ...
              <div className="flex items-center">
                ...
                />
                <span className="md:hidden" onClick={sendEmail}>
                  <PaperIcon className="h-14 w-14 transform rounded-r-lg bg-[#0F97B8] p-3 text-white transition-all  duration-200 ease-in-out active:scale-105 md:hidden " />
                </span>
              </div>
            </label>
