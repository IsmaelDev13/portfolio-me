...
export const PersonalProjects3: React.FC<PersonalProjectsProps> = ({
  ...
  return (
    <div className="my-20 mx-auto flex max-w-7xl flex-col items-center pt-20 text-[#262f3d] lg:hidden lg:flex-row">
      ...
      <div className="relative mx-4 my-5 rounded-md border-4 border-[#0F97B8] shadow-sm shadow-[#0F97B8] ">
